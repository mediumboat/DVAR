...
#     parser.add_argument('--path', type=str, default="../data/movielen/ml-100k/metapath.all" ,help="input_path")
#     parser.add_argument('--output_file', default="../data/movielen/ml-100k/metapath_embs.out", type=str, help='output_file')
